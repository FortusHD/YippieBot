...
describe('wichteln', () => {
    ...
    describe('execute', () => {
        ...
        test('should start wichtel loop', async () => {
            ...
            expect(resetParticipants).toHaveBeenCalled();
            ...
            expect(insertOrUpdateId).toHaveBeenCalledWith('wichtelId', mockMessage.id);
            expect(setWichtelData).toHaveBeenCalledWith({
                wichteln: true,
                end: '11.12.2025, 23:59:59',

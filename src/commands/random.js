...
module.exports = {
	...
	data: new SlashCommandBuilder()
		...
		.addStringOption(option =>
			option
				.setName('objects')
				.setDescription('Alle möglichen Einträge, aus denen eines zufällig gewählt werden soll (mit "," getrennt)')
				.setRequired(true)),
		...
		if (objects.length > 0) {
			...
			const randomEmbed = buildEmbed({
				...
				fields: [
					...
					{ name: 'Wahrscheinlichkeit:', value: `${Math.round((1 / objects.length) * 100) / 100}%`, inline: true },
